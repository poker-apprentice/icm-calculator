...
describe('calculate', () => {
  it('works for empty payouts', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([]);
  });
  ...
  it('works for one player remaining', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([10_000]);
  });
  ...
  it('works for two payouts and two players', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([89.33, 86.67]);
  });
  ...
  it('works for two payouts and three players', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([67.06, 58.73, 50.21]);
  });
  ...
  it('works for two payouts and three players with identical stacks', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([64.44, 64.44, 47.12]);
  });
  ...
  it('works for two payouts and four players', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([61.05, 52.68, 44.73, 17.54]);
  });
  ...
  it('works for two payouts and five players', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([57.08, 48.82, 41.28, 16.08, 12.74]);
  });
  ...
  it('works for three payouts and three players', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([332.99, 290.56, 211.45]);
  });
  ...
  it('works for four payouts and four players', () => {
    ...
    expect(calculate({ payouts, chipStacks })).toEqual([323.2, 278.12, 195.79, 112.89]);
  });
});
